...
import { Upload, Video, Download, AlertCircle } from 'lucide-react';
import Button from '../../components/ui/Button';

const VideoToMP4Page = () => {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      // Convert to MP4
      const convertRes = await fetch('http://localhost:3001/api/video/convert-to-mp4', {
        method: 'POST',
      ...
      <div className="container-custom">
        ...
        <div className="text-center mb-12">
          ...
          <h1 className="text-5xl font-black text-text-primary mb-4">
            Convert Video to <span className="gradient-text">MP4</span>
          </h1>
          <p className="text-xl text-text-secondary max-w-2xl mx-auto">
            Convert AVI, MOV, MKV, WebM, and other video formats to MP4
          </p>
        </div>
